...
It's also simple to write examples for resourceful controllers that may be nested, make_resourceful-style:

  # config/routes.rb
  ActionController::Routing::Routes.draw do |map|
    map.resources :cats, :has_many => :toys
  end

  # spec/controllers/toys_controller_spec.rb
